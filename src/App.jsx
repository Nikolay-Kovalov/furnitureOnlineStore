...
class App extends React.Component{
    ...
    onLargeItemClick = (largeItem) => {
        ...
        // console.log(this.state.isLargeItem)
        // console.log(this.state.largeItem)
    }
    ...
    render() {
        ...
        return (
            <div className="app">
                <Routes>
                    <Route path="/" element={<Layout  sum = {this.sum} orders={orders} onDeleteOrder={this.onDeleteOrder} />}>
